...
export default function BlogPost() {
      ...
      <div className="min-h-screen bg-white py-12 md:py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="animate-pulse space-y-8">
            ...
            <div className="h-[300px] md:h-[500px] bg-gray-200 rounded"></div>
            <div className="space-y-4">
  ...
  const getImageClassName = () => {
    ...
    return `${alignmentClasses[blog.image?.alignment || 'center']} ${sizeClasses[blog.image?.size || 'full']}`;
  };
    ...
    <div className="min-h-screen bg-white">
      ...
      <article className="py-6 md:py-24">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Title & Meta */}
          <div className="mb-8">
            <h1 className="text-2xl md:text-4xl font-light mb-4 md:mb-6">{blog.title}</h1>
          ...
          <div className="prose prose-lg max-w-none">
            {paragraphs.map((paragraph, index) => (
              <p key={index} className="mb-6 text-gray-800 leading-relaxed text-base md:text-lg">
                {paragraph}
              </p>
            ))}
          </div>
